	...
	<section class="bg-neutral-2 py-[7rem] dark:bg-neutral-30">
		<div class="text-center container px-[2.2rem] lg:px-[3.5rem] xl:px-[7rem]">
			...
			<div class="mt-[3rem] grid gap-y-[3rem] md:grid-cols-2 md:gap-[2rem] xl:grid-cols-4 lg:gap-[5rem] xl:gap-[2rem]">
				<div
					class="rounded-lg overflow-hidden max-w-[45rem] mx-auto sm:mx-auto md:w-auto lg:h-[40.4rem] xl:h-auto hover:cursor-pointer lg:hover:scale-110 transition-transform duration-300 border-[3px] border-transparent dark:border-neutral-3"
