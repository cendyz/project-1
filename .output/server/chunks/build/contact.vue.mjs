  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({
        class: "h-[95rem] lg:py-[5rem] flex justify-center items-center",
        ref: "el"
      }, _attrs))}><form class="bg-neutral-4 p-[3rem] border-dashed border-[3px] border-primary-3 w-[calc(100%-6rem)] mx-auto my-auto max-w-[540px] lg:p-[5rem] lg:max-w-[580px] z-[100]"><h1 class="text-[2.5rem] font-w700 mb-[1rem] lg:text-[3rem]">Contact us</h1><p class="text-[1.4rem] mb-[2rem] lg:text-[1.5rem]"> Got any questions or suggestions? <br class="sm:hidden"> Fill out this form to reach out. </p><div><div><label for="name" class="${ssrRenderClass(labelStyles)}">Name</label><input type="text" id="name" class="${ssrRenderClass([inputStyles, unref(name_error) && "border-primary-red"])}" placeholder="Enter your name"${ssrRenderAttr("value", unref(input_data).name)}>`);
      if (unref(name_error)) {
