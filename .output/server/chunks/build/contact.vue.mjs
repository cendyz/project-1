...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(is_sended)) {
        _push(`<div class="absolute z-[1000] w-[30rem] bg-primary-1 top-[5%] h-[15rem] rounded-xl my_shadow flex flex-col justify-between overflow-hidden lg:right-[7rem] xl:right-[9rem]"><button aria-label="close pop up" class="ml-auto block p-[1rem]"><img${ssrRenderAttr("src", unref(closeMenu))} alt="x" class="invert-[100]"></button><h2 class="text-[2rem] text-center font-w700 mb-[5rem] text-white">Message successfully sent!</h2><div class="my_line"></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</main>`);
