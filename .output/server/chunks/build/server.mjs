...
const img5 = "" + __buildAssetsURL("img5.nJVRMDp8.jpg");

const img6 = "" + __buildAssetsURL("img6.Bj_H-tuz.jpg");
...
const is_45page_45exists_45global = defineNuxtRouteMiddleware((to) => {
...
export { _export_sfc as _, useRuntimeConfig as a, useRouter as b, useBankStore as c, useRoute as d, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useNuxtApp as u };
