...
const _routes = [
  ...
  },
  {
    name: "articles",
    path: "/articles",
    component: () => import('./articles.vue.mjs')
  },
  {
    name: "blog",
    path: "/blog",
  ...
  },
  {
    name: "careers",
    path: "/careers",
    component: () => import('./careers.vue.mjs')
  },
  {
    name: "contact",
    path: "/contact",
...
export { _export_sfc as _, useRuntimeConfig as a, useBankStore as b, useRouter as c, nuxtLinkDefaults as d, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useNuxtApp as u };
