...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="pt-[13rem] pb-[5rem] px-[3rem] dark:bg-neutral-21" data-v-dd0ffb6c>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/news" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(back))} alt="back to news" class="${ssrRenderClass([unref(store).isLight && "light_arrow", "mb-[2rem] inline"])}" data-v-dd0ffb6c${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: unref(back),
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd0ffb6c"]]);
