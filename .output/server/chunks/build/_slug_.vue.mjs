...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="pt-[13rem] pb-[5rem] px-[3rem] bg-neutral-3 dark:bg-neutral-21" data-v-2989b96d>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/news" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(back))} alt="back to news" class="${ssrRenderClass([unref(store).isLight && "light_arrow", "mb-[2rem] inline"])}" data-v-2989b96d${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: unref(back),
      ...
      _push(`<h1 class="text-[3.3rem] font-w700 sm:text-center dark:text-primary-10" data-v-2989b96d>${ssrInterpolate(unref(store).articles_data[unref(store).news.indexOf(unref(route).params.slug)].title)}</h1></header><main class="dark:bg-neutral-21 bg-neutral-3" data-v-2989b96d>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2989b96d"]]);
