...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="relative"><div class="container pt-[15rem] py-[7rem] lg:pt-[11rem] lg:h-[50rem] p-[3rem] lg:px-[3.5rem] xl:px-[7rem]"><p class="px-[1.2rem] lg:mt-[5rem] py-[.5rem] border-primary-3 border rounded-3xl w-fit">FAQs</p><div class="mt-[2rem]"><label for="question" class="text-[4rem] text-primary-1 lg:text-[5rem]">What can we help you find?</label><input type="text" id="question" class="block mt-[3rem] w-full p-[1rem] rounded-md border border-primary-3 bg-neutral-4 z-[100] relative lg:w-[40rem]"${ssrRenderAttr("value", unref(input_data).user_print)}></div></div><div class="bg"></div></header><main class="px-[3rem] py-[10rem] container sm:w-[70rem] lg:w-auto lg:grid lg:grid-cols-2 lg:gap-x-[10rem] lg:px-[3.5rem] xl:px-[7rem]"><!--[-->`);
