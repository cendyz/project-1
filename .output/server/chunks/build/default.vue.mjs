  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "navMenu",
        ref: navMenu
      }, _attrs))} data-v-4c6a12c5><div class="px-[3rem] flex justify-between relative container lg:items-center lg:justify-between lg:px-[3.5rem] xl:px-[7rem]" data-v-4c6a12c5>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(logo))} class="w-[5rem] h-[5rem] z-[50]" alt="logo easybank" data-v-4c6a12c5${_scopeId}><p class="font-w700 text-[2rem] hidden sm:block text-[#2d314d]" data-v-4c6a12c5${_scopeId}>mWallet</p>`);
          } else {
            return [
              createVNode("img", {
                src: unref(logo),
      ...
      _push(`<button type="button" aria-label="open close nav menu" class="lg:hidden" data-v-4c6a12c5><img${ssrRenderAttr("src", unref(store).isOpenMenu ? unref(closeMenu) : unref(hamburger))}${ssrRenderAttr("alt", unref(store).isOpenMenu ? "close menu" : "open menu")} class="${ssrRenderClass([unref(store).isOpenMenu ? "w-[2rem] h-[2.1rem]" : "w-[2.8rem]", "h-[1.8rem] z-[100]"])}" data-v-4c6a12c5></button>`);
      if (unref(store).isOpenMenu) {
        _push(`<div class="absolute top-[9.5rem] w-[calc(100%-4.4rem)] left-1/2 translate-x-[-50%] justify-items-center bg-neutral-4 grid gap-y-[1.5rem] py-[3rem] rounded-md lg:none" data-v-4c6a12c5><!--[-->`);
      ...
      _push(`<div class="hidden lg:flex gap-x-[3.5rem]" data-v-4c6a12c5><!--[-->`);
      ssrRenderList(linksData.value, (item, index) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`<!--]--></div><button type="button" class="hidden lg:block capitalize bg-gradient-to-r from-primary-2 to-primary-3 text-neutral-4 px-[2.8rem] py-[1.1rem] rounded-full font-w700 text-[1.4rem] lg:hover:opacity-60 lg:transition-opacity" data-v-4c6a12c5> request invite </button></div></nav>`);
    };
  }
});
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4c6a12c5"]]);
