...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-neutral-2 dark:bg-neutral-20 py-[11rem] px-[2.2rem] text-center text-neutral-1 dark:text-neutral-10 text-[1.5rem] md:text-[1.6rem] lg:z-[9] relative" }, _attrs))} data-v-9c194635><div class="container lg:px-[3.5rem] xl:px-0" data-v-9c194635><h2 class="text-[3rem] font-w700 leading-[1.2] mb-[2.2rem] px-[1rem] text-primary-1 dark:text-neutral-10 md:text-[3.5rem] lg:px-0" data-v-9c194635> Why choose mWallet? </h2><p class="sm:w-[38rem] text-primary-1 dark:text-primary-10 px-[2rem] mt-[2rem] leading-[2] sm:mx-auto lg:w-[55rem] lg:mx-auto" data-v-9c194635> With seamless digital integration, BlueWallet transforms your phone into a smart financial command center. Manage money intuitively and securely. </p><div class="mt-[7rem] grid gap-y-[3rem] lg:grid lg:grid-cols-2 lg:gap-y-[6rem] xl:flex xl:justify-items-center xl:flex-wrap lg:w-[90rem] lg:mx-auto" data-v-9c194635><!--[-->`);
      ssrRenderList(unref(profitsData), (item, index) => {
        _push(`<div data-aos="zoom-in-up"${ssrRenderAttr("data-aos-once", true)}${ssrRenderAttr("data-aos-duration", 400)}${ssrRenderAttr("delay", index * 200)} class="bg-neutral-3 dark:bg-neutral-30 bg-opacity-50 p-[2rem] border lg:border-[2px] rounded-xl lg:border-primary-2 dark:border-primary-1 max-w-[45rem] mx-auto lg:w-auto z-[10]" data-v-9c194635><div class="p-[2rem]" data-v-9c194635><img${ssrRenderAttr("src", item.img)}${ssrRenderAttr("alt", item.title)} class="block mx-auto w-[7rem] h-[7rem] md:w-[8rem] md:h-[8rem]" data-v-9c194635><h3 class="text-primary-1 dark:text-primary-10 text-[2.5rem] font-w700 my-[2rem] md:text-[2.2rem]" data-v-9c194635>${ssrInterpolate(item.title)}</h3><ul class="text-left text-primary-1 dark:text-primary-10 sm:w-[35rem] sm:mx-auto lg:w-[30rem] lg:mx-0 list-disc grid gap-y-[2rem]" data-v-9c194635><li data-v-9c194635>Lorem ipsum dolor sit amet con se cte tur adi pisic ing elit. Eligendi, quae. Lorem, ipsum.</li><li data-v-9c194635>Lorem ipsum dolor sit amet con se cte tur adi pcs icing elit. Eligendi, quae. Lorem, ipsum.</li></ul><div class="flex justify-between items-center mt-[3rem] relative" data-v-9c194635><button type="button" class="bg-gradient-to-r from-primary-2 to-primary-3 text-neutral-4 px-[2.8rem] py-[1.1rem] rounded-full font-w700 text-[1.4rem] md:text-[1.6rem] lg:hover:opacity-60 lg:transition-opacity lg:dark:hover:opacity-100 lg:dark:hover:text-primary-1 lg:dark:transition-colors" data-v-9c194635> Check </button><button type="button" class="underline italic rounded-full font-w700 md:text-[1.6rem] text-[1.1rem]" data-v-9c194635> law note </button>`);
        if (unref(is_law) == index) {
          _push(`<div class="absolute w-[20rem] rounded-xl text-left h-[20rem] text-primary-1 bg-neutral-4 dark:bg-neutral40 p-[2rem] overflow-scroll lg:overflow-hidden right-[.6rem] bottom-[5rem] z-[10] md:w-[25rem] md:right-[1.7rem] md:bottom-[6rem] boxShadowLaw" data-v-9c194635><p class="text-[1.2rem] font-w700" data-v-9c194635> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam eligendi quibusdam sapiente pariatur, exercitationem doloremque nihil autem omnis laboriosam esse hic temporibus vel at veniam ut maxime totam necessitatibus minima. </p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(is_law) == index) {
          _push(`<div class="absolute bottom-[3rem] right-[.5rem] md:right-7 md:bottom-[4rem] z-[11]" data-v-9c194635><img${ssrRenderAttr("src", unref(triangle))} alt="" aria-hidden="true" class="w-[3rem] invert-[100%]" data-v-9c194635></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      });
      _push(`<!--]--></div></div><img${ssrRenderAttr("src", unref(icon1))} alt="" aria-hidden="true" class="${ssrRenderClass([[iconStyles, unref(store).isLight && "darkIconsBg"], "top-[35rem] left-[-2rem] md:top-[30rem] md:left-[5rem] lg:top-[20rem] 2xl:left-[35rem] rotate-12 animeSpin"])}" data-v-9c194635><img${ssrRenderAttr("src", unref(icon2))} alt="" aria-hidden="true" class="${ssrRenderClass([[iconStyles, unref(store).isLight && "darkIconsBg"], "right-[5rem] top-[130rem] md:top-[120rem] lg:top-[75rem] rotate-45 animeSpin 2xl:right-[30rem]"])}" data-v-9c194635><img${ssrRenderAttr("src", unref(icon3))} alt="" aria-hidden="true" class="${ssrRenderClass([[iconStyles, unref(store).isLight && "darkIconsBg"], "left-[2rem] bottom-[1rem] md:left-[4rem] rotate-6 animeSpinRight 2xl:left-[19rem] 2xl:bottom-[10rem]"])}" data-v-9c194635></section>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9c194635"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid py-[10rem] px-[3rem] pb-[10rem] bg-neutral-3 dark:bg-neutral-21" }, _attrs))} data-v-9916a146><div data-v-9916a146><div class="lg:w-[50rem] lg:mx-auto lg:text-center" data-v-9916a146><h2 class="capitalize text-[2.8rem] md:text-[3.5rem] mb-[2rem] text-primary-1 dark:text-neutral-10" data-v-9916a146> Over 20 Tools to Manage Your Finances. Unlimited Control. </h2><p class="leading-[1.7] text-primary-1 dark:text-neutral-10" data-v-9916a146> Track your expenses in real time. Set smart budgets with just a few taps. Plan your savings goals and manage your money anywhere, anytime. With mWallet, your financial future is in your hands. </p></div><div class="grid gap-[3rem] mt-[5rem] sm:block sm:columns-2 lg:grid lg:grid-cols-2 grid_cols lg:w-[100rem] lg:mx-auto" data-v-9916a146><!--[-->`);
      ssrRenderList(unref(grid_data), (item, index) => {
        _push(`<div data-aos="zoom-in-up"${ssrRenderAttr("data-aos-once", true)}${ssrRenderAttr("delay", index * 200)} prefetch class="${ssrRenderClass([[item.my_class, item.img ? "lg:flex-row " : "lg:flex-col"], "border-[2px] border-primary-1 dark:border-primary-10 rounded-3xl lg:flex lg:items-center overflow-hidden mx-auto lg:max-w-[100%] lg:mx-0 max-w-[40rem] sm:mb-[3.5rem] lg:mb-0"])}" data-v-9916a146><div class="p-[2rem] lg:m-auto lg:text-left" data-v-9916a146><h3 class="font-w700 mb-[2rem] text-[2rem]" data-v-9916a146>${ssrInterpolate(item.title)}</h3><p data-v-9916a146>${ssrInterpolate(item.desc)}</p></div>`);
        if (item.img) {
          _push(`<img${ssrRenderAttr("src", item.img)} alt="phone" class="block lg:h-[30rem]" data-v-9916a146>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9916a146"]]);
