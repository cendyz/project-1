...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-neutral-2 py-[11rem] px-[2.2rem] text-center text-neutral-1 text-[1.5rem] md:text-[1.6rem] lg:z-[9] relative" }, _attrs))} data-v-f99235d3><div class="container lg:px-[3.5rem] xl:px-0" data-v-f99235d3><h2 class="text-[3rem] font-w700 leading-[1.2] mb-[2.2rem] px-[1rem] text-primary-1 md:text-[3.5rem] lg:px-0" data-v-f99235d3> Why choose mWallet? </h2><p class="sm:w-[38rem] text-primary-1 px-[2rem] mt-[2rem] leading-[2] sm:mx-auto lg:w-[55rem] lg:mx-auto" data-v-f99235d3> With seamless digital integration, BlueWallet transforms your phone into a smart financial command center. Manage money intuitively and securely. </p><div class="mt-[7rem] grid gap-y-[3rem] lg:grid lg:grid-cols-2 lg:gap-y-[6rem] xl:flex xl:justify-items-center xl:flex-wrap lg:w-[90rem] lg:mx-auto" data-v-f99235d3><!--[-->`);
      ssrRenderList(profitsData.value, (item, index) => {
        _push(`<div${ssrRenderAttr("data-aos", is_width.value && unref(width) >= 1024 ? "zoom-in" : "")}${ssrRenderAttr("data-aos-once", true)}${ssrRenderAttr("data-aos-duration", 700)} class="bg-neutral-3 bg-opacity-50 p-[2rem] border lg:border-[2px] rounded-xl lg:border-primary-2 max-w-[45rem] mx-auto lg:w-auto z-[10]" data-v-f99235d3><div class="p-[2rem]" data-v-f99235d3><img${ssrRenderAttr("src", item.img)}${ssrRenderAttr("alt", item.title)} class="block mx-auto w-[7rem] h-[7rem] md:w-[8rem] md:h-[8rem]" data-v-f99235d3><h3 class="text-primary-1 text-[2.5rem] font-w700 my-[2rem] md:text-[2.2rem]" data-v-f99235d3>${ssrInterpolate(item.title)}</h3><ul class="text-left text-primary-1 sm:w-[35rem] sm:mx-auto lg:w-[30rem] lg:mx-0 list-disc grid gap-y-[2rem]" data-v-f99235d3><li data-v-f99235d3>Lorem ipsum dolor sit amet con se cte tur adi pisic ing elit. Eligendi, quae. Lorem, ipsum.</li><li data-v-f99235d3>Lorem ipsum dolor sit amet con se cte tur adi pcs icing elit. Eligendi, quae. Lorem, ipsum.</li></ul><div class="flex justify-between items-center mt-[3rem] relative" data-v-f99235d3><button type="button" class="bg-gradient-to-r from-primary-2 to-primary-3 text-neutral-4 px-[2.8rem] py-[1.1rem] rounded-full font-w700 text-[1.4rem] md:text-[1.6rem] lg:hover:opacity-60 lg:transition-opacity" data-v-f99235d3> Check </button><button type="button" class="underline italic rounded-full font-w700 md:text-[1.6rem] text-[1.1rem]" data-v-f99235d3> law note </button>`);
        if (is_law.value == index) {
          _push(`<div class="absolute w-[20rem] rounded-xl text-left h-[20rem] text-black bg-white p-[2rem] overflow-scroll lg:overflow-hidden right-[.6rem] bottom-[5rem] z-[10] md:w-[25rem] md:right-[1.7rem] md:bottom-[6rem] boxShadowLaw" data-v-f99235d3><p class="text-[1.2rem] font-w700" data-v-f99235d3> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam eligendi quibusdam sapiente pariatur, exercitationem doloremque nihil autem omnis laboriosam esse hic temporibus vel at veniam ut maxime totam necessitatibus minima. </p></div>`);
        } else {
          _push(`<!---->`);
        }
        if (is_law.value == index) {
          _push(`<div class="absolute bottom-[3rem] right-[.5rem] md:right-7 md:bottom-[4rem] z-[11]" data-v-f99235d3><img${ssrRenderAttr("src", unref(triangle))} alt="" aria-hidden="true" class="w-[3rem] invert-[100%]" data-v-f99235d3></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      });
      _push(`<!--]--></div></div><img${ssrRenderAttr("src", unref(icon1))} alt="" aria-hidden="true" class="${ssrRenderClass([iconStyles, "top-[35rem] left-[-2rem] md:top-[30rem] md:left-[5rem] lg:top-[20rem] rotate-12 animeSpin"])}" data-v-f99235d3><img${ssrRenderAttr("src", unref(icon2))} alt="" aria-hidden="true" class="${ssrRenderClass([iconStyles, "right-[5rem] top-[130rem] md:top-[120rem] lg:top-[75rem] rotate-45 animeSpin 2xl:right-[12%]"])}" data-v-f99235d3><img${ssrRenderAttr("src", unref(icon3))} alt="" aria-hidden="true" class="${ssrRenderClass([iconStyles, "left-[2rem] bottom-[1rem] md:left-[4rem] rotate-6 animeSpinRight 2xl:left-[7%] 2xl:bottom-[13%]"])}" data-v-f99235d3></section>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f99235d3"]]);
